...
public class UpdateContactsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (called_from.equalsIgnoreCase("add")) {
            ...
            ContactInfoActivity c = dbHandler.Get_Contact(USER_ID);
        ...
        add_save_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (valid_name != null && valid_mob_number != null
                    ...
                    dbHandler.Add_Contact(new ContactInfoActivity(valid_name,
        ...
        update_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (valid_name != null && valid_mob_number != null
                    ...
                    dbHandler.Update_Contact(new ContactInfoActivity(USER_ID, valid_name,
                            valid_mob_number, valid_email));
                    dbHandler.close();
        ...
        update_view_all.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent view_user = new Intent(UpdateContactsActivity.this,
